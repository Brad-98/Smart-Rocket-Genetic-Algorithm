function Rocket(dna) 
{
  ...
  this.update = function() 
  {
    ...
    // Rocket hit the asteroid
    if (this.pos.x > asteroid1XPos && this.pos.x < asteroid1XPos + asteroidWidth && this.pos.y > asteroid1YPos && this.pos.y < asteroid1YPos + asteroidHeight)
    {
      this.crashed = true;
    }
    if (this.pos.x > asteroid2XPos && this.pos.x < asteroid2XPos + asteroidWidth && this.pos.y > asteroid2YPos && this.pos.y < asteroid2YPos + asteroidHeight)
    {
      this.crashed = true;
    }
    if (this.pos.x > asteroid3XPos && this.pos.x < asteroid3XPos + asteroidWidth && this.pos.y > asteroid3YPos && this.pos.y < asteroid3YPos + asteroidHeight)
    {
      this.crashed = true;
    }
    if (this.pos.x > asteroid4XPos && this.pos.x < asteroid4XPos + asteroidWidth && this.pos.y > asteroid4YPos && this.pos.y < asteroid4YPos + asteroidHeight)
    {
      this.crashed = true;
    }
